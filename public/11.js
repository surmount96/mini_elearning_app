...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", {}, [
      _c("h3", { staticClass: "text-h4 text-blue font-bold" }, [
        _vm._v("Guardian Dashboard")
      ]),
      _vm._v(" "),
      _c("p", { staticClass: "text-medium text-blue my-3" }, [
        _vm._v(
          "Welcome. Here are the things you can do. You can always find them on the sidebar on the left."
        )
      ]),
      _vm._v(" "),
      _c("p")
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "flex flex-wrap my-4" }, [
      _c("div", { staticClass: "lg:w-3/12 md:w-3/12 sm:w-1/2 w-full mb-4" }, [
        _c(
          "div",
          {
            staticClass:
              "bg-white shadow rounded-md px-4 py-5\n                 lg:mr-2 md:mr-2"
          },
          [
            _c("div", { staticClass: "mb-4" }, [
              _c(
                "p",
                { staticClass: "text-large my-1 text-blue font-semibold" },
                [_vm._v("Classes")]
              ),
              _vm._v(" "),
              _c("p", { staticClass: "text-medium text-gray-grayer" }, [
                _vm._v(
                  "Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates amet veniam totam laboriosam."
                )
              ])
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "mt-5" }, [
              _c("img", {
                staticClass: "w-32 ml-auto",
                attrs: { src: "/img/icon/classroom.svg", alt: "classroom" }
              })
            ])
          ]
        )
        ...
        _c(
          ...
          [
            ...
            _c("div", { staticClass: "mt-5" }, [
              _c("img", {
                staticClass: "w-32 ml-auto",
                attrs: { src: "/img/icon/learner.svg", alt: "classroom" }
              })
            ])
          ]
        )
